...
{
    public class ProductPageObjects : BasePage
    {

        public ProductPageObjects(IWebDriver driver) : base(driver)
        {
        }

        private IWebElement? AddToBasketButton => _driver?.FindElement(By.Id("form-action-addToCart"));
        public IWebElement? DecreaseItemPc => _driver?.FindElement(By.CssSelector("button[data-action='dec']"));
        public IWebElement? IncreaseItemPc => _driver?.FindElement(By.CssSelector("button[data-action='inc']"));
